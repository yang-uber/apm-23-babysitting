...
import Image from './Remaining30_ss.png'; // an image is defined here using file path

function Remaining30() {
    let navigate = useNavigate();
    return (
        <div className='Home page'>
            <div style={{ position: 'relative', width: '375px', height: '812px', backgroundImage: `url(${Image})`, backgroundSize: 'cover' }}>
            </div>
            <Button onClick={() => { navigate(`/remaining15`) }} className='entire-screen' // CHANGE
            style={{
                width: '360px',
                height: '780px',
                position: 'absolute',
